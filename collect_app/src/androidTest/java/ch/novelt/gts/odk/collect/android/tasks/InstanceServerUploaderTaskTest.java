...
import ch.novelt.gts.odk.collect.android.test.MockedServerTest;
...
import static ch.novelt.gts.odk.collect.android.test.TestUtils.assertMatches;
import static ch.novelt.gts.odk.collect.android.test.TestUtils.cleanUpTempFiles;
import static ch.novelt.gts.odk.collect.android.test.TestUtils.createTempFile;
import static ch.novelt.gts.odk.collect.android.test.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTaskTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("Dalvik/.* ch.novelt.gts.odk.collect.android/.*", r.getHeader("User-Agent"));
