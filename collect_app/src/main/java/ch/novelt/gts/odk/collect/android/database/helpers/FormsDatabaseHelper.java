...
package ch.novelt.gts.odk.collect.android.database.helpers;

import android.database.sqlite.SQLiteDatabase;
import android.database.sqlite.SQLiteOpenHelper;

import ch.novelt.gts.odk.collect.android.application.Collect;
import ch.novelt.gts.odk.collect.android.database.DatabaseContext;
import ch.novelt.gts.odk.collect.android.utilities.CustomSQLiteQueryBuilder;

import timber.log.Timber;

import static android.provider.BaseColumns._ID;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.AUTO_DELETE;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.AUTO_SEND;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.BASE64_RSA_PUBLIC_KEY;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.DATE;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.DESCRIPTION;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.DISPLAY_NAME;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.DISPLAY_SUBTEXT;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.FORM_FILE_PATH;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.FORM_MEDIA_PATH;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.JRCACHE_FILE_PATH;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.JR_FORM_ID;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.JR_VERSION;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.LANGUAGE;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.LAST_DETECTED_FORM_VERSION_HASH;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.MD5_HASH;
import static ch.novelt.gts.odk.collect.android.provider.FormsProviderAPI.FormsColumns.SUBMISSION_URI;
