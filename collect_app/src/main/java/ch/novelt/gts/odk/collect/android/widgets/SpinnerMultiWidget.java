...
import ch.novelt.gts.odk.collect.android.widgets.warnings.SpacesInUnderlyingValuesWarning;
...
public class SpinnerMultiWidget extends ItemsWidget implements ButtonWidget, MultiChoiceWidget {
    ...
    public SpinnerMultiWidget(final Context context, FormEntryPrompt prompt) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            styledAnswerItems[i] = ch.novelt.gts.odk.collect.android.utilities.TextUtils.textToHtml(answerItems[i]);
        }
    ...
    private void showSelectedValues(List<String> selectedValues) {
        if (selectedValues.isEmpty()) {
            ...
            CharSequence answerText = ch.novelt.gts.odk.collect.android.utilities.TextUtils.textToHtml(String.format(getContext().getString(R.string.selected_answer),
